...
const jsonData = `[
  {
    ...
    "infoText": "Nós armazenamos dados temporariamente para melhorar a sua experiência de navegação e recomendar conteúdo de seu interesse. Ao utilizar nossos serviços, você concorda com tal monitoramento.",
    "mainTitle": "CONFIGURAÇÕES DE COOKIES",
    "lastUpdate": "21/12/2022",
    "entryText": "Você pode alterar as configurações de cookies ativando ou desativando os cookies analíticos e de terceiros aqui. Você não pode desativar os cookies estritamente necessários. Você pode descobrir mais sobre descendo a página.",
    "selectAll": false,
    ...
    "cookieGroups": [
      {
        ...
        "groupText": "Esses cookies são essenciais para sites e para que seus recursos funcionem corretamente. Sem esses cookies, certos serviços podem ser desativados.",
        "cookieList": [
          {
      ...
      {
        "groupId": "experiencia",
        "groupName": "Experiência do site e cookies de terceiros",
        "groupOptOut": true,
        "groupSelected": false,
        "groupAlertMessage": "Ao desativar essa opção, sua navegação ficará comprometida",
        "groupText": "Esses cookies são instalados por terceiros, por exemplo, redes sociais. Seu principal objetivo é integrar o conteúdo de mídia social em nosso site, como plug-ins sociais.",
        "cookieList": [
          {
    ...
    "noteList": [
      {
        ...
        "answer": "Os cookies são arquivos que contêm pequenos fragmentos de dados — como um nome de usuário e uma senha — que são trocados entre o computador de um usuário e um servidor Web para identificar usuários específicos e melhorar sua experiência de navegação."
      },
      {
        "question": "Informações?",
        "answer": "Cookies podem armazenar informações pessoais, como dados da conta do usuário e informações de login usadas para acessar certos sites, preferências de idioma, endereço de entrega e muito mais."
      },
      {
        "question": "Finalidade?",
        "answer": "Eles permitem que um usuário fique conectado aos sites, usá-los no idioma escolhido, navegar em sites de comércio eletrônico com itens salvos no carrinho de compras e muito mais. Os cookies que ajudam os sites a realizar funções críticas são chamados de cookies primários. Sem eles, seria impossível usar completamente a internet."
      }
    ],
    "links": [
      {
