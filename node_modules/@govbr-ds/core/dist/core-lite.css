...
.br-list .br-checkbox + .br-list .br-checkbox {
  margin-top: var(--spacing-scale-base);
}
...
.br-list .br-checkbox input[indeterminate]:checked + label::after {
  border-color: var(--background-light);
  border-width: 0 0 3px;
  top: 2px;
  transform: none;
}
.br-list .br-checkbox.is-invalid input + label::before, .br-list .br-checkbox.invalid input + label::before, .br-list .br-checkbox[invalid] input + label::before {
  --border-color: var(--danger);
}
.br-list .br-checkbox.is-invalid input:focus-visible:checked + label::before,
.br-list .br-checkbox.is-invalid input:focus-visible + label::before, .br-list .br-checkbox.is-invalid input.focus-visible:checked + label::before,
.br-list .br-checkbox.is-invalid input.focus-visible + label::before, .br-list .br-checkbox.invalid input:focus-visible:checked + label::before,
.br-list .br-checkbox.invalid input:focus-visible + label::before, .br-list .br-checkbox.invalid input.focus-visible:checked + label::before,
.br-list .br-checkbox.invalid input.focus-visible + label::before, .br-list .br-checkbox[invalid] input:focus-visible:checked + label::before,
.br-list .br-checkbox[invalid] input:focus-visible + label::before, .br-list .br-checkbox[invalid] input.focus-visible:checked + label::before,
.br-list .br-checkbox[invalid] input.focus-visible + label::before {
  --border-color: var(--focus-color);
}
.br-list .br-checkbox.is-invalid input:checked + label::before, .br-list .br-checkbox.invalid input:checked + label::before, .br-list .br-checkbox[invalid] input:checked + label::before {
  --border-color: var(--danger);
}
.br-list .br-checkbox.is-valid input + label::before, .br-list .br-checkbox.valid input + label::before, .br-list .br-checkbox[valid] input + label::before {
  --border-color: var(--success);
}
.br-list .br-checkbox.is-valid input:focus-visible:checked + label::before,
.br-list .br-checkbox.is-valid input:focus-visible + label::before, .br-list .br-checkbox.is-valid input.focus-visible:checked + label::before,
.br-list .br-checkbox.is-valid input.focus-visible + label::before, .br-list .br-checkbox.valid input:focus-visible:checked + label::before,
.br-list .br-checkbox.valid input:focus-visible + label::before, .br-list .br-checkbox.valid input.focus-visible:checked + label::before,
.br-list .br-checkbox.valid input.focus-visible + label::before, .br-list .br-checkbox[valid] input:focus-visible:checked + label::before,
.br-list .br-checkbox[valid] input:focus-visible + label::before, .br-list .br-checkbox[valid] input.focus-visible:checked + label::before,
.br-list .br-checkbox[valid] input.focus-visible + label::before {
  --border-color: var(--focus-color);
}
.br-list .br-checkbox.is-valid input:checked + label::before, .br-list .br-checkbox.valid input:checked + label::before, .br-list .br-checkbox[valid] input:checked + label::before {
  --border-color: var(--success);
}
.br-list .br-checkbox.is-small input + label, .br-list .br-checkbox.small input + label, .br-list .br-checkbox[small] input + label {
  line-height: var(--spacing-scale-2xh);
  min-height: var(--spacing-scale-2xh);
}
.br-list .br-checkbox.is-small input + label::before, .br-list .br-checkbox.small input + label::before, .br-list .br-checkbox[small] input + label::before {
  height: var(--spacing-scale-2xh);
  width: var(--spacing-scale-2xh);
}
.br-list .br-checkbox.is-small input:checked + label::after, .br-list .br-checkbox.small input:checked + label::after, .br-list .br-checkbox[small] input:checked + label::after {
  border-width: 0 2px 2px 0;
  height: var(--icon-size-sm);
  left: 7px;
  top: 6px;
...
.br-list .br-checkbox.is-small input:checked[indeterminate] + label::after, .br-list .br-checkbox.small input:checked[indeterminate] + label::after, .br-list .br-checkbox[small] input:checked[indeterminate] + label::after {
  border-color: var(--background-light);
  border-width: 0 0 3px;
  top: 2px;
  transform: none;
...
/*# sourceMappingURL=core-lite.css.map*/