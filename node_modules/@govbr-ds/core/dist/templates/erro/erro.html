          ...
          <div class="header-bottom">
            <div class="header-menu">
              ...
              <div class="header-info">
                <div class="header-title">Template de Erro</div>
                ...
                <div class="template-erro">
                  ...
                  <div class="row my-5 text-center justify-content-lg-center">
                    <div class="col-lg-auto">
                      <button class="br-button" type="button"><i class="fas fa-chevron-left" aria-hidden="true"></i><span>Ir para Página Anterior</span>
                      </button>
                    </div>
                    <div class="col-lg-auto mt-1 mt-lg-0">
                      <button class="br-button" type="button"><i class="fas fa-home" aria-hidden="true"></i><span>Ir para Página Principal</span>
                      </button>
                    </div>
                    <div class="col-lg-auto mt-1 mt-lg-0">
                      <button class="br-button" type="button"><i class="fas fa-comment-dots" aria-hidden="true"></i><span>Envie um Feedback</span>
                      </button>
                    </div>
                  </div>
                </div>
